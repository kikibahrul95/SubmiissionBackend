...
const editByIdHandler = (request, h) => {
  ...
  if (readPage > pageCount) {
    // Readpage lebuh besar dari page Count
    const response = h
      .response({
        status: 'fail',
        message:
